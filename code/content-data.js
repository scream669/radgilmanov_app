    ...
    <button style="background: none; border: none; padding: 0; cursor: pointer; width: 100%;" 
        ...
        <div style="margin-top: 8px; color: #8e8e93; font-size: 14px;">Нажмите для увеличения</div>
                    ...
                    },
                    {
                        ...
                        articles: [
                            { id: 'openloops_1', title: "Открытые петли", content: `<div class="article-image" style="margin: 20px 0;">
        <img src="https://github.com/scream669/radgilmanov_app/blob/main/pictures/open_loops.jpg?raw=true" alt="Фото 3" style="width: 100%; max-width: 100%; height: auto; border-radius: 8px;">
    </div>` }
                        ]
                    },
                    {
